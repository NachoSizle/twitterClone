...
install("reywood:publish-composite");                                                                                  // 91
install("ui");                                                                                                         // 92
install("iron:core");                                                                                                  // 93
install("iron:dynamic-template");                                                                                      // 94
install("iron:layout");                                                                                                // 95
install("iron:url");                                                                                                   // 96
install("iron:middleware-stack");                                                                                      // 97
install("iron:location");                                                                                              // 98
